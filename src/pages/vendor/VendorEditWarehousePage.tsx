...
function VendorEditWarehousePage() {
  ...
  if (!warehouseId) {
    return <Navigate to={VENDOR_ROUTES.warehouses} replace />
  }
  ...
  return (
    <VendorLayout title="Edit Warehouse" backTo={VENDOR_ROUTES.warehouses} backTitle="Back to Warehouses">
        <div>
              ...
              {loading ? (
                ...
                <form onSubmit={handleSubmit} className="d-flex flex-column gap-3">
                  ...
                  <div className="d-flex justify-content-end gap-2 pt-2">
                    <button type="button" className="btn btn-light border" onClick={() => navigate(VENDOR_ROUTES.warehouses)} disabled={saving}>
                      Cancel
                    </button>
...
export default VendorEditWarehousePage
